...
int strings_main() {
    ...
    // You can run into buffer overflow for not having the adecuated space to hold the data
    char userInput[21];
    ...
    // After the limit is reached, chracters after this will be ignored as there has to be space for the null char
    ...
    // String allow for manipulation and resizing of the buffer as needed
    ...
    // As seen by the examples above, strings are more versatile. They can be resized, concatenated, initialized
